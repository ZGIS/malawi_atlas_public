            ...
            layers: [
              {
                ...
                description:
                  "Statistics taken from the 2008 Malawi Census related to villages across Salima. Click on a village to view statistics such as population, number of households, males, females and average ages.",
                year: 2008,
            ...
            layers: [
              {
                ...
                description:
                  "Features and facilities mapped in villages across Salima such as boreholes, village headman houses, schools, churches, mosques and more. Also contains statistics about GVHs.",
                year: "Unknown",
                source: "Z_GIS & COOPI",
                layer_extent: "Salima",
                projection: "WGS 84(EPSG: 4326)",
              ...
              },
              {
                ...
                thematicGroup: "SALIMA_DISASTER",
                description:
                  "Locations of village civil protection comittees trained by COOPI between 2009 and 2011",
                year: 2012,
                source: "COOPI",
                layer_extent: "Salima",
                projection: "WGS 84(EPSG: 4326)",
              ...
              },
              {
                ...
                thematicGroup: "SALIMA_DISASTER",
                description:
                  "This layer indicates the infrastructure that may help reduce the risk from disasters,such as early warning systems, river gauges, identified evacuation shelters, grain silos and irrigation systems.Data collected by COOPI between 2010 and 2011.",
                year: "Unknown",
                source: "COOPI",
                layer_extent: "Salima",
                projection: "WGS 84(EPSG: 4326)",
              ...
              },
              {
                ...
                thematicGroup: "SALIMA_DISASTER",
                description:
                  "Locations of village clinics, health centres and dispensaries in Salima District, including the coordinates, and the name and founder, where available.Data collected by COOPI, 2014.",
                year: 2014,
                source: "COOPI",
                layer_extent: "Salima",
                projection: "WGS 84(EPSG: 4326)",
              ...
              },
              {
                ...
                thematicGroup: "SALIMA_DISASTER",
                description:
                  "Traditional authorities(TAs)and villages in Salima District",
                year: 2008,
                source: "Z_GIS & COOPI",
                layer_extent: "Salima",
                projection: "WGS 84(EPSG: 4326)",
            ...
            layers: [
              {
                ...
                description:
                  "This dataset indicates strong wind hazards delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
                source: "COOPI & Z_GIS",
                year: 2013,
              ...
              },
              {
                ...
                description:
                  "This dataset indicates the locations of cholera outbreaks delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                source: "COOPI & Z_GIS",
                year: 2013,
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Human wildlife conflict is common in Malawi, with crocodiles posing a particular problem to communities living near water sources. This dataset indicates known crocodile zones delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                source: "COOPI & Z_GIS",
                year: 2013,
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "This dataset indicates crop pest infestations delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                source: "COOPI & Z_GIS",
                year: 2013,
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "This dataset indicates flood hazard zones delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                source: "COOPI & Z_GIS",
                year: 2013,
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "This dataset indicates dry spell hazard zones delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2013.",
                source: "COOPI & Z_GIS",
                year: 2013,
                layer_extent: "Nsanje",
                projection: "WGS 84 (EPSG: 4326)",
          ...
          },
          {
            ...
            layers: [
              ...
              },
              {
                ...
                description:
                  "Community and other centres - including village halls, cooperatives, community-based organisations, ADMARC Centres and more, identified and georeferenced in targeted flood-prone areas of Nsanje District. Data was collected during a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Nsanje, targeted vulnerable communities",
                projection: "WGS 84 / UTM Zone 36 South (EPSG: 32736)",
              ...
              },
              {
                ...
                description:
                  "Markets identified and georeferenced in targeted flood-prone areas of Nsanje District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Nsanje, targeted vulnerable communities",
                projection: "WGS 84 / UTM Zone 36 South (EPSG: 32736)",
          ...
          },
          {
            ...
            layers: [
              ...
              },
              {
                ...
                description:
                  "Water points identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. Knowing the location of water points is essential in emergency situations to ensure that clean water is accessable at all times.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Telecommunication towers identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. Communication is critical in emergencies, but towers can become damaged in strong winds and rains. Knowing the location of towers and the networks they cover is essential",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Hazard monitoring equipment (river and rain gauges) identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. River and rain gauges act as an early warning system for floods if monitored reguarlly. When used efficiently, they can limit the impacts of flood events.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Evacuation routes identified by community leaders in targeted communities in Mangochi District. This data was collected in June 2018 during a Mapathon organised by COOPI/Concern Worldwide and involving relevant VCPCs as well as staff from the Department of Disaster Management, Department of Surveys and the ADDRMO. These evacuation routes generally lead from identified flood-prone areas to a safe area or evacuation centre.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 / UTM 36S (EPSG: 32736)",
              ...
              },
              {
                ...
                description:
                  "Maize mills identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Markets identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Selected power lines identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. Power stations are critical in emergencies as they are sources of electricity. However they can become damaged in disasters and knowing their locations can help determine their risk.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Power stations identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. Power stations are critical in emergencies as they are sources of electricity. However they can become damaged in disasters and knowing their locations can help determine their risk.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Schools identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO. If away from disaster-prone areas, schools can provide space and refuge for affected communities in the event of floods.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "Village headman houses identified and georeferenced in targeted flood-prone areas of Mangochi District. Data was collected during a Mapathon in June 2018 and a data collection activity in Spring 2018. These activities were organised by COOPI / Concern Worldwide and involved relevant VCPCs as well as staff from the Department of Disaster Management Affairs, Department of Surveys and the ADDRMO.",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 (EPSG: 4326)",
            ...
            layers: [
              {
                ...
                description:
                  "Rivers identified by community leaders in targeted communities in Mangochi District, delineated from satellite and UAV imagery. This data was collected in June 2018 during a Mapathon organised by COOPI/Concern Worldwide and involving relevant VCPCs as well as staff from the Department of Disaster Management, Department of Surveys and the ADDRMO",
                year: "2018",
                source: "COOPI and Concern Worldwide",
                layer_extent: "Mangochi, targeted vulnerable communities",
                projection: "WGS 84 / UTM 36S (EPSG: 32736)",
        ...
        groups: [
          {
            ...
            layers: [
              ...
              },
              {
                ...
                name:
                  "linthipe_lingadzi_linthipe_flood_model_affected_areas_2006-03",
                opacity: 0.6,
                description:
                  "This layer is a modelled estimation of the flood extent during the March 2006 flood event in the region. It was produced through a dyanamical flood modelling approach, based on precipitation data from six measuring stations in the region and a digital elevation model (DEM) from the Forestry Department. The 'zebra' effect in the downstream area is due to the accuracy of the DEM. See attached report for more details.",
                year: 2012,
          ...
          },
          {
            ...
            layers: [
              ...
              },
              {
                ...
                opacity: 0.6,
                description:
                  "This layer indicates the change in forest cover between 1990 and 2009 based on classification of two Landsat satellite images from 11/07/1990 and 29/06/2009.",
                year: 2012,
                source: "Z_GIS & COOPI",
                layer_extent: "Linthipe and Lingadzi Catchments",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                opacity: 0.6,
                description:
                  "Land use and land cover dataset derived from classification of a Landsat image from 29/06/2009. See full report for more details.",
                year: 2012,
                source: "Z_GIS & COOPI",
                layer_extent: "Linthipe and Lingadzi Catchments",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                opacity: 0.6,
                description:
                  "Land use and land cover dataset derived from classification of a Landsat image from 11/07/1990. See full report for more details.",
                year: 2012,
                source: "Z_GIS & COOPI",
                layer_extent: "Linthipe and Lingadzi Catchments",
                projection: "WGS 84 (EPSG: 4326)",
            ...
            layers: [
              {
                ...
                description:
                  "This dataset indicates storm hazards delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2011.",
                source: "COOPI & Z_GIS",
                year: 2011,
              ...
              },
              {
                ...
                description:
                  "Human wildlife conflict is common in Malawi, with crocodiles posing a particular problem to communities living near water sources. Elephants meanwhile can come into conflict with human around croplands. This dataset indicates known crocodile and elephant zones delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2011.",
                source: "COOPI & Z_GIS",
                year: 2011,
                layer_extent: "Chikwawa",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "This dataset indicates flood hazard zones delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2011.",
                source: "COOPI & Z_GIS",
                year: 2011,
                layer_extent: "Chikwawa",
                projection: "WGS 84 (EPSG: 4326)",
              ...
              },
              {
                ...
                description:
                  "This dataset indicates the locations of cholera outbreaks delineated in participatory GIS (PGIS) exercises undertaken with district officers in 2011.",
                source: "COOPI & Z_GIS",
                year: 2011,
                layer_extent: "Chikwawa",
                projection: "WGS 84 (EPSG: 4326)",
          ...
          },
          {
            ...
            layers: [
              ...
              },
              {
                ...
                year: "1980 -2001",
                source:
                  "UNEP (http://preview.grid.unep.ch/index.php?preview=data&events=droughts&evcat=4)",
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG:4326)",
                data_type: "Raster",
                raster_properties: {
          ...
          },
          {
            ...
            layers: [
              ...
              },
              {
                ...
                description:
                  "Primary and secondary school locations in Malawi based on data from MASDAP collected in 2013. Schools when out of disaster-prone areas, can be used as evacuation centres in case of flood emergencies for example.",
                year: 2013,
                source: "MASDAP",
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
            ...
            layers: [
              {
                ...
                detailed_description:
                  "The proportion of males to females in each enumeration area (EA)",
                year: 2008,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              },
              {
                ...
                detailed_description:
                  "The average density of households in number of households per square kilometre in each enumeration area (EA)",
                year: 2008,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              },
              {
                ...
                detailed_description:
                  "The average density of population in number of persons per quare kilometre in each enumeration area (EA)",
                year: 2008,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
            ...
            layers: [
              {
                ...
                description:
                  "proportion of all individuals whose level of consumption is below the basic-needs poverty line. Basic needs refer to food, water, shelter and clothing. Values range from 0 to 1, where 1 means all the population live below the poverty line.",
                year: 1998,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              },
              {
                ...
                description:
                  "Average maximum years spent in education by the population in the aggregated enumeration area.",
                year: 1998,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              },
              {
                ...
                name: "malawi_gini",
                description:
                  "this is the Gini index of consumption inequality. The higher the number, the greater the inequality.",
                year: 1998,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              {
                title:
                  "Average travel time to nearest TA-level market centre (hours)",
                name: "malawi_nearest_market",
                description:
                  "this is the average travel time in hours to the nearest sub-district (TA-level) market centre.",
                year: 1998,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
              ...
              },
              {
                ...
                description:
                  "total number of people aged under 15 and over 65 years divided by the total population. Provides an estimate of the proportion of the population that are ‘dependent’ on working adults.",
                year: 1998,
                layer_extent: "Malawi",
                projection: "WGS 84 (EPSG: 4326)",
                source:
